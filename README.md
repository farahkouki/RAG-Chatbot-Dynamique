...
- Recherche intelligente de réponses
- Interface web interactive avec **Streamlit**
- Gestion des embeddings avec **ChromaDB**
- Modèle de similarité de texte avec **Sentence Transformers**
- Système de seuil pour filtrer les documents pertinents
...
|------------|-------------|
| ![Python](https://img.shields.io/badge/Python-3776AB?style=for-the-badge&logo=python&logoColor=white) | Langage principal |
| ![Streamlit](https://img.shields.io/badge/Streamlit-FF4B4B?style=for-the-badge&logo=streamlit&logoColor=white) | Interface web interactive |
| ![ChromaDB](https://img.shields.io/badge/ChromaDB-2D2D2D?style=for-the-badge&logo=data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABAAAAAQ...) | Base d'embeddings |
